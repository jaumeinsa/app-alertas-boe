...
export const metadata: Metadata = {
  title: "¿Qué montañas salen en mi foto?",
  description:
    "Sube una foto de montaña y descubre qué cimas aparecen: usamos el GPS y la orientación de la cámara de la propia foto para etiquetar cada pico.",
  robots: { index: false },
};
